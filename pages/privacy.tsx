  ...
  return (
    ...
    >
      <section className="">
        ...
        <p className="pt-4">This policy is effective as of 27 August 2021. </p>
        <p>Last updated: 27 August 2021 </p>
        <h3 className="pt-4 text-2xl font-bold">Information We Collect</h3>
        <p className="pt-4">
        ...
        <h4 className="pt-4 text-xl font-bold">Log Data</h4>
        <p className="pt-4">
        ...
        <h4 className="pt-4 text-xl font-bold">Device Data</h4>
        <p className="pt-4">
          When you visit our website or interact with our services, we may automatically collect
          data about your device, such as:{' '}
        </p>
        <ul>
          <li className="pt-4">•Device Type</li>
          <li className="pt-4">•Geo-location data</li>
        </ul>
        <p className="pt-4">
        ...
        <h4 className="pt-4 text-xl font-bold">User-Generated Content</h4>
        <p className="pt-4">
        ...
        <h4 className="pt-4 text-xl font-bold">Collection and Use of Information</h4>
        <p className="pt-4">
          We may collect personal information from you when you do any of the following on our
          website:{' '}
        </p>
        <ul className="pt-4">
          <li className="pt-4">•Use a mobile device or web browser to access our content</li>
          <li className="pt-4">
            •Contact us via email, social media, or on any similar technologies
          </li>
          <li className="pt-4">•When you mention us on social media</li>
        </ul>
        <p className="pt-4">
          ...
          Our marketing and market research activities may uncover data and insights, which we may
          combine with information about how visitors use our site to improve our site and your
          experience on it.{' '}
        </p>
        <h4 className="pt-4 text-xl font-bold">Security of Your Personal Information</h4>
        <p>
        ...
        <h4 className="pt-4 text-xl font-bold">How Long We Keep Your Personal Information</h4>
        <p className="pt-4">
          ...
          For example, if you have provided us with personal information such as an email address
          when contacting us about a specific enquiry, we may retain this information for the
          duration of your enquiry remaining open as well as for our own records so we may
          effectively address similar enquiries in future. If your personal information is no longer
          required for this purpose, we will delete it or make it anonymous by removing all details
          that identify you.{' '}
        </p>
        <p className="pt-4">
        ...
        <h3 className="pt-4 text-2xl font-bold">Children’s Privacy</h3>
        <p className="pt-4">
        ...
        <p className="pt-4">We may disclose personal information to: </p>
        <ul className="pt-4">
          <li className="pt-4">•a parent, subsidiary, or affiliate of our company</li>
          <li className="pt-4">
            ...
            problem-solving providers, marketing providers, professional advisors, and payment
            systems operators
          </li>
          <li className="pt-4">•our employees, contractors, and/or related entities</li>
          <li className="pt-4">•our existing or potential agents or business partners</li>
          <li className="pt-4">
          ...
          <li className="pt-4">•third parties to collect and process data</li>
          <li className="pt-4">
            •an entity that buys, or to which we transfer all or substantially all of our assets and
            business
          </li>
        </ul>
        <p className="pt-4">Third parties we currently use include: </p>
        <ul className="pt-4">
          <li className="pt-4">•Google Analytics</li>
          <li className="pt-4">•Mixpanel</li>
          <li className="pt-4">•MailChimp</li>
        </ul>
        <h3 className="pt-4 text-2xl font-bold">
          Your Rights and Controlling Your Personal Information
        </h3>
        <p className="pt-4">
          <strong className="pt-4 font-bold">Your choice:</strong> By providing personal information
          to us, you understand we will collect, hold, use, and disclose your personal information
          in accordance with this privacy policy. You do not have to provide personal information to
          us, however, if you do not, it may affect your use of our website or the products and/or
          services offered on or through it.{' '}
        </p>
        <p className="pt-4">
          <strong className="font-bold">Information from third parties:</strong> If we receive
          personal information about you from a third party, we will protect it as set out in this
          privacy policy. If you are a third party providing personal information about somebody
          else, you represent and warrant that you have such person’s consent to provide the
        ...
        <p className="pt-4">
          ...
          required to provide you with a particular service or offer (for example providing user
          support), we will not deny you goods or services and/or charge you different prices or
        ...
        <h3 className="pt-4 text-2xl font-bold">Use of Cookies</h3>
        <p className="pt-4">
        ...
        <p className="pt-4">Please refer to our Cookie Policy for more information. </p>
        <h3 className="pt-4 text-2xl font-bold">Business Transfers</h3>
        <p className="pt-4">
        ...
        <h3 className="pt-4 text-2xl font-bold">Limits of Our Policy</h3>
        <p className="pt-4">
        ...
        <h3 className="pt-4 text-2xl font-bold">Changes to This Policy</h3>
        <p className="pt-4">
        ...
        <h3 className="pt-4 text-2xl font-bold">Contact Us</h3>
        <p className="pt-4">

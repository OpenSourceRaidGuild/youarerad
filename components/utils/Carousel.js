  ...
  },
  {
    theslide: (
      <Twitter
        ...
        text={
          <div>
            Today was one of the best days of my life! We raised $57,000 For RAD today in less than
            4 hours. I LOVE MY COMUNITY SO MUCH 🥳{' '}
  ...
  },
  {
    theslide: (
      <Twitter
        ...
        name="Emma"
        author="@EmmaMeiLi"
        media="https://pbs.twimg.com/profile_images/1424732772535611394/_GgAflbO_400x400.jpg"
      ...
      <Twitter
        ...
        text={
          <div>
            ...
            and the money will help so many people. The stream helped my family and I heal so much,
            and for that I am forever in your debt. Sincerely, I love you all. ❤️{' '}
            <a href="https://twitter.com/youarerad">
              <span className="text-blue-700">@YouAreRAD</span>
            </a>
          </div>
  ...
  return (
    <>
      <Swiper
        ...
        slidesPerView={1}
        freeMode={{ momentum: true, momentumRatio: 1 }}
        grabCursor={true}
      ...
      >
        {slides.map((slide, index) => (
          <SwiperSlide key={index}>{slide.theslide}</SwiperSlide>
        ))}
      </Swiper>
    </>
  )

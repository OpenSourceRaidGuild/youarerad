...
const Tabs = ({ color }) => {
  ...
  return (
    <>
      <div className="pt-4 lg:pt-16 lg:grid lg:grid-cols-2 lg:gap-x-24">
        <div className="">
          <div className="relative col-start-1">
            <div className="">
              <ul role="tablist" className="max-w-3xl mx-auto space-y-10 lg:space-y-20">
                <li className="space-y-2">
                  ...
                  >
                    <span
                      className={
                        openTab === 1
                          ? 'font-bold text-2xl lg:text-5xl text-blue-700'
                        ...
                        <div className="relative ">
                          <div className="w-full px-6 py-4 bg-white border border-gray-300 rounded">
                            ...
                            <div className="mt-4 mb-2 text-lg leading-normal text-gray-800 whitespace-pre-wrap">
                              Just got off a call in tears because it seems like I am finally going
                              to be able to get decent and consistent therapy soon. Thank you{' '}
                ...
                <li className="space-y-2">
                  ...
                  >
                    ...
                    >
                      I&apos;m unable to afford therapy
                    </span>
                    <span></span>
                  </a>
                  <div className={openTab === 2 ? 'block' : 'hidden'} id="link2">
                    <p className="mt-2 text-xl text-gray-800 lg:pr-12">
                      No insurance or budget? We&apos;ll find you the best possible licensed
                      therapist in your area and cover the cost with donations.
                    </p>
                    <div className="relative inline-flex flex-row items-center mt-2 text-lg group">
                      <a
                        href="#"
                ...
                <li className="space-y-2">
                  ...
                  <div className={openTab === 3 ? 'block' : 'hidden'} id="link3">
                    <p className="mt-2 text-xl text-gray-800 lg:pr-12">
                      We&apos;ll find your team the best possible licensed therapists and use the
                      cost to help others.
                    </p>
                    <div className="relative inline-flex flex-row items-center mt-2 text-lg group">
                      <a
        ...
        <div className="relative w-full">
              ...
              <div className="">
                <div className="relative">
                  <div className="w-full px-6 py-4 my-4 bg-white border border-gray-300 rounded">
                    ...
                    <div className="mt-4 mb-2 text-lg leading-normal text-gray-800 whitespace-pre-wrap">
                      Just got off a call in tears because it seems like I am finally going to be
                      able to get decent and consistent therapy soon. Thank you{' '}
                      <span className="text-blue-400">
                        <a href="https://twitter.com/YouAreRAD">@YouAreRAD</a>
                      </span>
                      😭🙌
                ...
                <div className="relative">
                  <div className="w-full px-6 py-4 my-4 bg-white border border-gray-300 rounded">
                    ...
                    <div className="mt-4 mb-2 text-lg leading-normal text-gray-800 whitespace-pre-wrap">
                      ...
                      , which has helped me return to going to therapy on a weekly basis and helps
                      pay for a number of the expenses related to my mental health needs.
                    </div>
                    <a
                      className="text-sm text-gray-800 hover:underline"
                      href="https://twitter.com/J5isLive/status/1423331897158029312"
          ...
          <div
            className={
              openTab === 3 ? 'hidden lg:flex lg:items-center h-full rounded-xl' : 'hidden'
            }
            id="link3"
          >
            <iframe
              className=" linkedin rounded-xl"
              src="https://www.linkedin.com/embed/feed/update/urn:li:share:6759920948922732544"
              frameBorder="0"
              allowFullScreen=""
              title="Embedded post"
...
export default function Faq() {
  return (
    <>
      <Tabs color="transform rotate-45" />
    </>
  )
}
